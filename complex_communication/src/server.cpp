...
void server::show_board()
{
  ...
  {
    ROS_INFO("%s %s %s",board.board_array[i] == 1 ?
      "X" : (board.board_array[i] == 2 ? "O" : "-"),
      board.board_array[i + 1] == 1 ?
      "X" : (board.board_array[i + 1] == 2 ? "O" : "-"),
      board.board_array[i + 2] == 1 ?
      "X" : (board.board_array[i + 2] == 2 ? "O" : "-"));
  }
  ROS_INFO("\n");
}
